...
const menuItems: MenuItem[] = [
  ...
  {
    id: 2001,
    name: "Croqueta de Mango y Kimchy",
    description: "Mínimo 4 unidades",
    price: 1.50,
    category: "Entrantes",
    isVegetarian: true,
    rating: 4.7,
  ...
  },
  {
    id: 2002,
    name: "Croquetón de Pollo Malai",
    description: "Grande, cremoso y muy jugoso, elaborado con pollo marinado en especias suaves y nata (mínimo 2 unidades)",
    price: 2.50,
    category: "Entrantes",
    rating: 4.8,
    allergens: ["gluten", "huevos", "lacteos"],
  ...
  {
    id: 2003,
    name: "Rabas de Santander con Ali Oli de Piparras",
    description: "Tiras de calamar rebozadas al estilo clásico, servidas con alioli suave de piparras",
    price: 13.50,
    category: "Entrantes",
    rating: 4.7,
    image: rabas,
  ...
  {
    id: 2004,
    name: "Provolone con Tomate y Jamón",
    description: "Provolone fundido con tomate y jamón",
    price: 12.00,
    category: "Entrantes",
    rating: 4.7,
    allergens: ["lacteos"],
  ...
  {
    id: 2005,
    name: "Zamburiñas con Leche de Coco",
    description: "Delicadas zamburiñas bañadas en salsa cremosa de leche de coco (6 unidades)",
    price: 14.50,
    category: "Entrantes",
    rating: 4.8,
    image: zamburinas,
  ...
  },
  {
    id: 2006,
    name: "Albóndigas de Langostino con Salsa de Coco",
    description: "Bocados tiernos de langostino en salsa cremosa de coco con un toque aromático (6 unidades)",
    price: 14.50,
    category: "Entrantes",
    rating: 4.8,
    image: albondigas,
  ...
  },
  {
    ...
    description: "Finas láminas de gamba aliñadas con aceite de oliva y cítricos",
    price: 14.90,
    category: "Entrantes",
    rating: 4.7,
    allergens: ["crustaceos"],
  },
  {
    ...
    description: "Salchichón, chorizo y lomo ibéricos",
    price: 17.00,
    category: "Entrantes",
    rating: 4.8,
  ...
  {
    id: 2010,
    name: "Ensaladilla de Langostino con Mahonesa de Bisqué",
    description: "Cremosa ensaladilla con langostinos y mahonesa de bisqué",
    price: 12.50,
    category: "Entrantes",
    rating: 4.7,
    image: ensaladilla,
  ...
  },
  {
    ...
    description: "Huevos rotos sobre patatas con jamón",
    price: 12.50,
    category: "Entrantes",
    rating: 4.7,
  ...
  {
    id: 2012,
    name: "Huevos rotos con Gambones en su salsa",
    description: "Huevos rotos sobre patatas con gambones jugosos en su salsa",
    price: 14.50,
    category: "Entrantes",
    rating: 4.8,
    allergens: ["gluten", "huevos", "crustaceos"],
  ...
  {
    id: 2013,
    name: "Gyoza Casa de Dosa",
    description: "Guiso de lechazo con ternera, pollo y cerdo (6 unidades)",
    price: 14.50,
    category: "Entrantes",
    rating: 4.8,
    image: gyozaRopaVieja,
  ...
  // Ensaladas
  {
    id: 2101,
    name: "Ensalada Mixta",
    description: "Ensalada mixta fresca de temporada",
    price: 7.50,
    category: "Ensaladas",
    isVegetarian: true,
    rating: 4.5,
  ...
  {
    id: 2102,
    name: "Ensalada de Mango y Manzana",
    description: "Ensalada fresca con mango y manzana",
    price: 12.50,
    category: "Ensaladas",
    isVegetarian: true,
    rating: 4.7,
  ...
  {
    id: 2103,
    name: "Burrata con Tartar de Pitahaya y Manzana",
    description: "Cremosa burrata sobre tartar fresco de pitahaya y manzana",
    price: 14.50,
    category: "Ensaladas",
    isVegetarian: true,
    rating: 4.8,
  ...
  {
    id: 2201,
    name: "Dosa Taco de Verdura",
    description: "3 unidades",
    price: 14.50,
    category: "Dosas en Taco",
    isVegetarian: true,
    rating: 4.7,
    allergens: ["gluten"],
  },
  {
    id: 2202,
    name: "Dosa Taco de Cochinita Pibil",
    description: "3 unidades",
    price: 14.50,
    category: "Dosas en Taco",
    rating: 4.8,
  ...
  },
  {
    id: 2205,
    name: "Unidad Extra",
    description: "Unidad adicional de dosa taco",
    price: 5.00,
    category: "Dosas en Taco",
    rating: 4.6,
    allergens: ["gluten"],
  ...
  {
    id: 2301,
    name: "Arroz de Marisco (mínimo 2 pax)",
    description: "Pulpo tierno, chipirones, langostinos, mejillones, boletus y verduras",
    price: 16.00,
    category: "Arroz",
    rating: 4.8,
    image: arrozMariscos,
    allergens: ["apio", "crustaceos", "moluscos"],
  },

  // Pescado
  {
    id: 2401,
    name: "Rodaballo con Crema de Coliflor y Salsa Ponzu",
    description: "Rodaballo fresco con crema cremosa de coliflor y salsa ponzu",
    price: 24.00,
    category: "Pescado",
    rating: 4.9,
    image: rodaballo,
  ...
  },
  {
    ...
    description: "Atún rojo fresco con sandía y ponzu de tomate",
    price: 20.00,
    category: "Pescado",
    rating: 4.8,
    image: tartarAtun,
  ...
  {
    id: 2501,
    name: "Entrecot a la plancha con Patatas fritas y Padrones",
    description: "Entrecot a la plancha con patatas fritas y pimientos de padrón",
    price: 25.00,
    category: "Carne",
    rating: 4.8,
    allergens: ["lacteos"],
  ...
  {
    id: 2502,
    name: "Rulo de Lechazo relleno de Duxelle y jugo de Frutos Rojos",
    description: "Rulo de lechazo tierno relleno de duxelle, con jugo de frutos rojos",
    price: 21.00,
    category: "Carne",
    rating: 4.9,
    image: ruloLechazo,
  ...
  },
  {
    id: 2503,
    name: "Hamburguesa de Vergara Beef con Yuca frita",
    description: "Jugosa hamburguesa de Vergara Beef acompañada de yuca frita",
    price: 18.00,
    category: "Carne",
    rating: 4.8,
    image: hamburguesa,
  ...
  {
    id: 2504,
    name: "Cachopo de Ternera con Jamón Ibérico y Queso",
    description: "Cachopo de ternera relleno de jamón ibérico y queso, acompañado de patatas fritas",
    price: 21.50,
    category: "Carne",
    rating: 4.8,
    allergens: ["gluten", "lacteos"],
  ...
  // Parrilla
  {
    ...
    description: "Disponible viernes, sábados y domingos",
    price: 26.00,
    category: "Parrilla",
    rating: 4.9,
    allergens: ["moluscos"],
  ...
  {
    id: 2603,
    name: "Pincho de Conejo a la Brasa",
    description: "Disponible viernes, sábados y domingos",
    price: 20.00,
    category: "Parrilla",
    rating: 4.7,
  ...
  {
    id: 2604,
    name: "Pincho de Lechazo a la Brasa",
    description: "Disponible viernes, sábados y domingos",
    price: 25.00,
    category: "Parrilla",
    rating: 4.8,
  ...
  },
  {
    ...
    description: "Disponible viernes, sábados y domingos. Precio según mercado",
    price: 0,
    category: "Parrilla",
    rating: 4.7,
    allergens: ["pescado"],
  ...
  {
    id: 2607,
    name: "Chuletón (Por encargo)",
    description: "Por encargo. Precio según mercado",
    price: 0,
    category: "Parrilla",
    rating: 4.9,
    allergens: [],
  ...
  {
    id: 2702,
    name: "Patatas fritas con Pimientos de Padrón",
    description: "Patatas fritas con pimientos de padrón",
    price: 7.00,
    category: "Guarnición",
    isVegetarian: true,
    rating: 4.6,
  ...
  },
  {
    ...
    description: "Pimientos de padrón salteados",
    price: 7.00,
    category: "Guarnición",
    isVegetarian: true,
    rating: 4.6,
  ...
  // Postre
  {
    id: 2801,
    name: "Tarta de Queso",
    description: "Nuestra cremosa tarta de queso",
    price: 7.50,
    category: "Postre",
    isVegetarian: true,
    rating: 4.8,
  ...
  {
    id: 2802,
    name: "Torrija con Crema de Leche de Coco y Helado de Turrón",
    description: "Torrija tradicional con crema de leche de coco y helado de turrón",
    price: 8.00,
    category: "Postre",
    isVegetarian: true,
    rating: 4.8,
  ...
  {
    id: 2803,
    name: "Pannacotta de Mango con Helado de Mango",
    description: "Pannacotta suave con mango y helado de mango",
    price: 7.00,
    category: "Postre",
    isVegetarian: true,
    rating: 4.7,
  ...
  },
  {
    id: 2804,
    name: "Mango Lazy",
    description: "Postre fresco de mango",
    price: 6.00,
    category: "Postre",
    isVegetarian: true,
    rating: 4.6,
  ...
  {
    id: 2805,
    name: "Dosa de Nutella",
    description: "Dosa fina rellena de Nutella fundida",
    price: 8.00,
    category: "Postre",
    isVegetarian: true,
    rating: 4.7,
  ...
  },
  {
    id: 2806,
    name: "Copa de Helado",
    description: "Copa de helado a elegir",
    price: 5.00,
    category: "Postre",
    isVegetarian: true,
    rating: 4.5,
  ...
  {
    id: 2807,
    name: "Carrot Halwa con Helado de Vainilla",
    description: "Nuestra famosa tarta de zanahoria con helado de vainilla",
    price: 7.50,
    category: "Postre",
    isVegetarian: true,
    rating: 4.8,
